...
**Problem:** You know theory, but don't understand how to put it all together: what System Prompt to use, what tools are needed, how to organize work cycle.
...
- If unsure about action — ask user
...
- Agent: "Issue resolved. Database working normally."
...
```text
You are a Customer Support Agent Tier 2.
...
4. If solution found — formulate answer
...
**Iteration 5:**
- Agent: Analyzes data and generates report: "Sales in region X dropped 30% last month. Main reason: decrease in product Y sales."
...
Your goal is to prepare a complete release plan for a feature.
...
3. Determine risks and rollback plan
...
All case studies show common patterns:

1. **SOP defines process** — clear action algorithm
2. **CoT helps follow process** — model thinks step by step
...
Choose a domain (DevOps, Support, Data, Security, Product) and create System Prompt following case study pattern:
...
Define tool set for your agent:

```go
tools := []openai.Tool{
    // Your code here
    // Include: main tools, security tools
}
```
...
- **Tools:** How to define tools, see [Chapter 04: Tools](../04-tools-and-function-calling/README.md)
...
- **[11. Best Practices and Application Areas](../11-best-practices/README.md)** — best practices for creating and maintaining agents

---

**Navigation:** [← Evals](../09-evals-and-reliability/README.md) | [Table of Contents](../README.md) | [Best Practices →](../11-best-practices/README.md)
