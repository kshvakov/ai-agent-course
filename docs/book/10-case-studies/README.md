...
- **Инструменты:** Как определять инструменты, см. [Главу 04: Инструменты](../04-tools-and-function-calling/README.md)
...
- **[11. Best Practices и Области Применения](../11-best-practices/README.md)** — лучшие практики создания и поддержки агентов

---

**Навигация:** [← Evals](../09-evals-and-reliability/README.md) | [Оглавление](../README.md) | [Best Practices →](../11-best-practices/README.md)
