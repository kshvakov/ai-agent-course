...
## Углубление: Почему Few-Shot работает?

> Этот раздел объясняет механику работы few-shot на уровне модели. Можно пропустить, если вас интересует только практика.
