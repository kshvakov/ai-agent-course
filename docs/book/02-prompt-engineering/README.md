...
Модель видит пример формата рассуждения и следует ему. На практике это происходит в цикле: каждый `Observation` добавляется runtime'ом в историю, и модель видит его при следующей итерации.
...
3. **Observation** — runtime выполняет инструмент и добавляет результат в историю (`role = "tool"`)
...
См. подробнее: **[Глава 05: Автономность и Циклы](../05-autonomy-and-loops/README.md)** — как работает ReAct Loop и итеративный процесс агента.
...
- **Инструменты:** Как промпт влияет на выбор инструментов, см. [Главу 04: Инструменты](../04-tools-and-function-calling/README.md)
- **Автономность:** Как SOP и CoT работают в цикле агента, см. [Главу 05: Автономность](../05-autonomy-and-loops/README.md)
