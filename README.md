...
👉 **[УЧЕБНИК: Проектирование Автономных AI Агентов](./docs/TEXTBOOK.md)**  
Полный учебник с теорией, примерами из разных доменов (DevOps, Support, Data, Security, Product), диаграммами и практическими советами.
