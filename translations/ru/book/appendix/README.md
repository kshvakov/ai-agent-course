...
**Episodic Memory (Эпизодическая память)** — память о конкретных событиях: "Пользователь спрашивал о месте на диске 2024-01-15". Полезна для отладки и обучения.
...
Это не магия — это просто цикл, где модель видит результаты предыдущих действий.
