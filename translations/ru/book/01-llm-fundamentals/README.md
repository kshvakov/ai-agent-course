...
> **Примечание:** Конкретные модели и размеры контекста могут меняться со временем. Важно понимать принцип: чем больше контекстное окно, тем больше информации агент может "помнить" в одном запросе.
