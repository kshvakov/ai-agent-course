...
## Goal
Научиться реализовывать системы памяти: долговременное хранилище, извлечение фактов, извлечение фактов и слои контекста.
...
- `Store(key string, value any) error` — сохранить факт
